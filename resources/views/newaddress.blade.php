            ...
            <div class='card-body'>
                <form method="POST" enctype="multipart/form-data" action="#">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postnumber" type="text" class="form-control @error('postnumber') is-invalid @enderror" name="postnumber" value="{{ old('postnumber') }}" required autocomplete="postnumber">
